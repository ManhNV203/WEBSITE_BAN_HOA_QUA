...
<body>
    <div class="container">
        ...
        <sf:form action="/nhan-vien/store" method="post" modelAttribute="data">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <sf:select path="ch" class="form-select" >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <sf:select path="cv" class="form-select" >
                        <c:forEach items="${datacv}" var="cv">
