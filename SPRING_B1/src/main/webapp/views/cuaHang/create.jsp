...
<body>
<div class="container">
    <sf:form action="/cua-hang/store" method="post" modelAttribute="data">
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                <sf:input class="form-control" path="diaChi"/>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                <sf:input class="form-control" path="quocGia"/>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                <sf:input class="form-control" path="thanhPho"/>
