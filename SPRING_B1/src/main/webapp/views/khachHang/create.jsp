...
<body>
<div class="container">
    <sf:form action="/khach-hang/store" method="post" modelAttribute="data">
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="ten_dem"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="ho"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="ngay_sinh"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="sdt"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="dia_chi"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="quoc_gia"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="thanh_pho"/>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
                ...
                <sf:errors cssStyle="color: red" path="mat_khau"/>
            </div>
        </div>
        <div>
