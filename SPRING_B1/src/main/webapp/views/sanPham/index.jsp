...
<body>
    <div class="container">
        <a href="/san-pham/create" class="btn btn-primary">Create</a>
        <table class="table">
            <thead>
            <tr>
                <th scope="col">STT</th>
            ...
            <c:forEach items="${listSP.content}" var="sp" varStatus="stt">
                <tr>
                    ...
                    <td>${sp.ten}</td>
                    <td>
                        <a href="/san-pham/edit/${sp.id}" class="btn btn-primary">details</a>
                        <a href="/san-pham/delete/${sp.id}" class="btn btn-primary">delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
